...
public class AuthController {
    ...
    // Generamos un estado único para cada solicitud de redirección a google y
    // github
    ...
    public RedirectView authenticateWithGoogle() { // Recibo la sesion del navegador, en este caso de google
        ...
        // Obtiene la URL de autenticación de Google//Genero un estado único para la
        // solicitud de redirección a google
    ...
    public ResponseEntity<?> callback(@PathVariable String provider, @RequestParam String code,
        ...
        if (this.state == null || !this.state.equals(state)) {
            // La línea completa devuelve este ResponseEntity al cliente, indicando que la
        ...
        if ("google".equalsIgnoreCase(provider)) {
            ...
            return ResponseEntity.ok(userInfo); // devuelve este ResponseEntity al cliente, indicando que la solicitud
                                                // fue exitosa y proporcionando la información del usuario.
        } else {
